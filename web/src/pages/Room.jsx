...
// IMPORTANT: keep this aligned with server.js STAGE_DURATIONS (seconds)
    ...
    <>
      ...
      <div className="room-wrap">
        ...
        {stage === 'CLOSED' && (roomMeta.finalAbstract || '').trim() && (
          ...
          >
            <div style={{ fontWeight: 800, marginBottom: 6 }}>🏁 Final Abstract</div>
        ...
        >
          ...
          {/* Sidebar */}
          {(stage === 'DISCOVERY' || stage === 'IDEA_DUMP') && <IdeaSidebar summary={ideaSummary} />}
